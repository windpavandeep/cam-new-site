...
<body class="mech-theme bg-slate-950 text-slate-100 antialiased min-h-screen relative">
    ...
    <div class="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(34,211,238,0.12),transparent_45%),linear-gradient(160deg,rgba(2,6,23,0.86),rgba(15,23,42,0.9)_45%,rgba(3,7,18,0.95))]"></div>
        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 flex flex-col bg-slate-900 text-white shadow-xl">
            ...
            <nav class="flex-1 space-y-0.5 px-3 py-2">
                ...
                <a href="{{ route('dashboard.categories.index') }}"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.categories*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.media.index') }}"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.media*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.slider.index') }}"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.slider*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.contact-settings.edit') }}"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.contact-settings*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.contact-messages.index') }}"
                    class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.contact-messages*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <span class="flex-shrink-0 rounded-full bg-amber-500 px-1.5 py-0.5 text-[10px] font-bold leading-none text-slate-900 tabular-nums">{{ $unread_contact_messages_count }}</span>
                    @endif
                </a>
                <a href="{{ route('dashboard.jobs.index') }}"
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.jobs*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.job-applications.index') }}"
                    class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('dashboard.job-applications*') ? 'bg-amber-500/20 text-amber-400' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    <span class="flex min-w-0 items-center gap-3">
                        <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="flex-shrink-0 rounded-full bg-amber-500 px-1.5 py-0.5 text-[10px] font-bold leading-none text-slate-900 tabular-nums">{{ $unread_job_applications_count }}</span>
                    @endif
                </a>
                @endif
